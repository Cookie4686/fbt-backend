...
type User struct {
	...
	PasswordEnabled bool                   `protobuf:"varint,5,opt,name=passwordEnabled,proto3" json:"passwordEnabled,omitempty"`
...
const file_common_user_proto_rawDesc = "" +
	"\n" +
	"\x11common/user.proto\x12\x06common\"\x98\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12$\n" +
	"\remailVerified\x18\x04 \x01(\bR\remailVerified\x12(\n" +
	"\x0fpasswordEnabled\x18\x05 \x01(\bR\x0fpasswordEnabledB\x1dZ\x1binternal/domain/auth/commonb\x06proto3"
